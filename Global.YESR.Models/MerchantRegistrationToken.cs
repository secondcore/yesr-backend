...
{
    // The registration token is used to track merchant users registrations.To make it unique, it is composed of the merchant id followed 
    ...
    public class MerchantRegistrationToken
    {
